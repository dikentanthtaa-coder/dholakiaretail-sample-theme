...
export function StatsSection() {
  return (
    <section className="py-24 border-y border-glass-border bg-bg-surface overflow-hidden">
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 divide-x divide-glass-border">
          {stats.map((s, i) => (
            ...
            >
              <div className="font-syne text-text-primary tracking-tighter text-[clamp(3rem,5vw,5rem)] font-extrabold leading-[1]">{s.value}</div>
