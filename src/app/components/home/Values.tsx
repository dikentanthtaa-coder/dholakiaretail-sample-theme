...
export function ValuesSection() {
  return (
    <section className="py-32 lg:py-48 relative z-20 bg-bg-deep">
          ...
          {valuesData.map((v, i) => {
            ...
            return (
              <motion.div key={v.title} ref={ref} onMouseMove={onMouseMove} onMouseLeave={onMouseLeave}
                ...
                className="group relative p-10 lg:p-14 rounded-3xl bg-bg-surface border border-glass-border hover:bg-glass-bg hover:border-glass-hover-border transition-colors duration-500 overflow-hidden"
              >
                ...
                <h3 className="font-syne relative z-10 text-text-primary tracking-tight text-[28px] font-bold">{v.title}</h3>
