...
export function ManufacturingSustainabilitySection({ smoothX, smoothY }: ManufacturingSustainabilityProps) {
  return (
    <section className="py-32 lg:py-48 bg-bg-deep overflow-hidden">
      {/* MANUFACTURING */}
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center mb-32 lg:mb-48">
