...
/**
 * Shared dark Midnight Navy CTA band — used on every page bottom.
 * All props are optional and fall back to the home defaults.
 */
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 60%, rgba(59,111,255,0.18) 0%, transparent 60%)",
          filter: "blur(80px)",
        }}
      />
